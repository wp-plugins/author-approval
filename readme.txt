...
If they have any issues with their page and wish to make those issues known, they can simply click on the 'Reject This Page' link, fill out the form that will appear detailing their issues, and that information will be sent as an e-mail to a specified e-mail address (the e-mail address can be set on the options page for the plugin, which will appear as a link under the Settings section of the dashboard).
...
2. list item Assigning an author to a page-
